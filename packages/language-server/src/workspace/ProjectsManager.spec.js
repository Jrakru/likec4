...
describe.concurrent('ProjectsManager', () => {
    ...
    describe('loadConfigFile', () => {
        ...
        it('should not load config file from node_modules', async ({ expect }) => {
            ...
            const project = await projectsManager.registerConfigFile(URI.parse('file:///test/workspace/node_modules/test-project/.likec4rc'));
    ...
    it('should exclude node_modules', async ({ expect }) => {
        ...
        expect(projectsManager.checkIfExcluded(URI.parse('file:///test/workspace/node_modules/doc.likec4'))).toEqual(true);
        expect(projectsManager.checkIfExcluded(URI.parse('file:///test/workspace/node_modules/deep/doc.likec4'))).toEqual(true);
    });
