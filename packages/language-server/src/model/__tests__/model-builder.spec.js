...
describe.concurrent('LikeC4ModelBuilder', () => {
    ...
    `);
        ...
        const indexView = await services.likec4.ModelBuilder.computeView('index');
    ...
    `);
        ...
        expect(warnings).toEqual([]);
        const indexView = withReadableEdges((await services.likec4.ModelBuilder.computeView('index')));
