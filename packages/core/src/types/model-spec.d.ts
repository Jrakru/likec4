...
import type { BorderStyle, Color, ColorLiteral, CustomColorDefinitions, ElementShape, RelationshipArrowType, RelationshipLineType, ShapeSize, SpacingSize, TextSize, ThemeColor } from '../styles/types';
