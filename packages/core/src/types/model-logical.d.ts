import type { BorderStyle, Color, ElementShape, RelationshipArrowType, RelationshipLineType, ShapeSize, SpacingSize, TextSize } from '../styles/types';
 ...
 */
export declare function ensureSizes<S extends WithSizes>({ size, padding, textSize, ...rest }: S, defaultSize?: TupleToUnion<readonly ["xs", "sm", "md", "lg", "xl"]>): Omit<S, 'size' | 'padding' | 'textSize'> & Required<WithSizes>;
...
export {};
//# sourceMappingURL=model-logical.d.ts.map