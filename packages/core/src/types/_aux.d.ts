 ...
 */
export interface Aux<Stage extends ModelStage, Element extends string, Deployment extends string, View extends string, Project extends string, Spec extends SpecAux<string, string, string, string, string>> {
    Stage: Stage;
    ProjectId: Project;
    ElementId: Element;
 ...
 */
export type Unknown = Aux<'layouted' | 'computed', string, string, string, string, SpecAux<string, string, string, string, string>>;
...
//# sourceMappingURL=_aux.d.ts.map