...
import type { BaseViewProperties, ViewAutoLayout, ViewManualLayout, ViewWithHash, ViewWithNotation } from './view-common';
import type { DynamicViewDisplayVariant } from './view-parsed.dynamic';
export type ComputedNodeStyle = Except<ElementStyle, 'icon' | 'shape' | 'color', {
...
export {};
//# sourceMappingURL=view-computed.d.ts.map