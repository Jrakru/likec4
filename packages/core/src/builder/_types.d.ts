...
import type { AnyAux, Aux, BorderStyle, ElementShape, ElementSpecification as ElementKindSpecification, Expression, KeysOf, LikeC4ProjectStylesConfig, NonEmptyArray, RelationshipArrowType, RelationshipLineType, RelationshipSpecification as RelationshipKindSpecification, ShapeSize, SpacingSize, SpecAux, TagSpecification, TextSize, ThemeColor as Color } from '../types';
