...
import { type Any, type Color, type DeployedInstance, type DeploymentElement, type DeploymentNode, type DeploymentRelationship, type ElementShape as C4ElementShape, type ElementStyle, type IteratorLike, type Link, type RelationshipArrowType, type RelationshipLineType, type RichTextOrEmpty, type scalar } from '../types';
...
export {};
//# sourceMappingURL=DeploymentElementModel.d.ts.map