...
import type { AnyAux, ComputedLikeC4ModelData, ComputedView, DiagramView, LayoutedLikeC4ModelData, ParsedLikeC4ModelData, scalar, ViewType, ViewWithType } from '../types';
...
export type ElementOrFqn<A extends AnyAux> = aux.ElementId<A> | {
    id: aux.Fqn<A>;
};
export type DeploymentOrFqn<A extends AnyAux> = aux.DeploymentId<A> | {
    id: aux.DeploymentFqn<A>;
};
export type ViewOrId<A extends AnyAux> = aux.ViewId<A> | {
