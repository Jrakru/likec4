...
import { type Element as C4Element, type ElementShape as C4ElementShape, type ElementStyle, type IconUrl, type Link, type ProjectId, type RichTextOrEmpty } from '../types';
