import { BorderStyles, computeColorValues, ElementShapes, RelationshipArrowTypes, Sizes, ThemeColors, } from '@likec4/core/styles';
...
const ThemeColorsSchema = z.union([
    z.record(color, ThemeColorValuesSchema),
    z.object(fromKeys(ThemeColors, () => ThemeColorValuesSchema.optional())),
]).meta({
    id: 'ThemeColors',
...
const LikeC4Config_Styles_Theme_Sizes = z
    .strictObject(fromKeys(Sizes, () => DimensionsSchema.optional()))
    .meta({
    id: 'ThemeSizes',
...
export const LikeC4StylesConfigSchema = z
    ...
    .transform(({ theme, defaults }) => exact({
